...
describe('fileHelper', () => {
    ...
    describe('createMinFileName', () => {
        it('should return testFile.min.js given testFile.js', () => {
            expect(fileHelper.createMinFileName('testFile.js')).toBe('testFile.min.js');
        });
        it('should return testFile2.min.js given testFile2.min.js', () => {
            expect(fileHelper.createMinFileName('testFile2.min.js')).toBe('testFile2.min.js');
        });
    });
});